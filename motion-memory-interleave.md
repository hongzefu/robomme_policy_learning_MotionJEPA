...
> **对应主计划**：`0901-motion-memory-plan.md`。主计划已于 2026-09-02 按本文改为交错方案（同时 `motion.stride` 20 → 16、`motion.budget` 80 → 96），本文随之换档；两文冲突以主计划为准。
...
主计划 `0901-motion-memory-plan.md` 已于 2026-09-02 按本文改为交错方案（与 `motion.stride` 16、`motion.budget` 96 一并换档），两文冲突以主计划为准。本文所述在主计划里的落点：
