...
- 确需修改 benchmark 时，先说明具体阻塞、文件和修改范围；只使用 `hongzefu/robomme_benchmark_MotionJEPA`，从原锁定提交建立 `PolicyEvalThirdParty-<主仓库任务分支>`。本轮对应 `PolicyEvalThirdParty-v2-eval-0917`。
