...
用户要求“一口气全做完”，并限定只使用四张GPU；本轮固定物理GPU 4–7。参考版本为 `99faacb1319adfc63c0cf9a15187e24c34e38fd1`，候选代码为 `c08ec2060a544af1869c1e24f755e536150569ca`。M8完整验收最终使用 `v1-store/train-runs/t8-m8-b/mme_vla_suite/t8-m8-b/999` 的1000更新EMA参数；该训练目前尚未开始，其余七关与48集闭环的启动记录待checkpoint产出后补充。
