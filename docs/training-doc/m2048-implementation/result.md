...
生产扩容及全部正确性、八卡容量验收已完成：输入、初态、旧两档完整回归、新2048参考/packed完整20+1、十记忆叶更新、最终功能门和100步保存加载全通过。[机器汇总](records/correctness.complete.json)记录正确性版本；[容量结果](../m2048-smoke/result.md)确认b128/w16/FSDP8运行和保存加载成功，共享内存峰值10.60%。独立测速尚未完成，当前未启动正式80k。
