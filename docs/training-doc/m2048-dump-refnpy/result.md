...
本侧实现为refnpy，CPU运行并以EXIT_CODE=0结束。packed于04:09:18Z启动、日志末次mtime约04:25:22Z；refnpy于04:09:20Z启动、末次mtime约04:26:59Z。它们是并发输入取证的墙钟，不能当作生产吞吐对照。
