...
| 目录 | 内容 | 判定 |
|---|---|---|
| [`v2-1600ep-m8x8-modul-b128-60k/`](v2-1600ep-m8x8-modul-b128-60k/launch.md) | 新库 1600 集、modulation 8×8、b128、60k、lr 5e-5，GPU 4–7 | 等价验证通过；smoke 与正式起跑待完成 |
| [`smoke-m8x8-modul-20260915T054007Z/`](smoke-m8x8-modul-20260915T054007Z/launch.md) | 正式 b128 四卡配置的 20 步 smoke 与 checkpoint 参数树验收 | 待跑 |
