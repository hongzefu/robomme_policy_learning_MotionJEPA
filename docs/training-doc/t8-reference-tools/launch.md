...
用户本轮指令：“开始实现 有问题越早问用户越好 一口气全做完！”；补充约束：“注意你只能用4个gpu”。全部 GPU 进程仅允许使用物理 GPU 4、5、6、7，阶段一冒烟使用 4、5。目标计划为根目录 `0908-8frame-8x8-training-plan.md`，本轮授权已经从计划文档扩展为按该计划实施、建库和验收。
