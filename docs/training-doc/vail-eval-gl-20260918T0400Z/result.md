...
| 硬件 | gl1519，A40，既有作业步骤 61331555.20，起跑显存 0 MiB，Default/shared |
...
| 视频 | 321 帧，962,450 字节，全部帧解码通过 |
| 起止时间 | 2026-09-18 04:51:59–04:57:12 UTC |
| 总耗时 | 313 秒，包含源码检查、渲染探针、模型校验、加载、首次编译、回合与视频验收 |
...
```text
/nfs/turbo/coe-chaijy-unreplicated/hongzefu/robomme_policy_learning_MotionJEPA/v1-store/evaluation/vail-eval-gl-20260918T0400Z/
```
