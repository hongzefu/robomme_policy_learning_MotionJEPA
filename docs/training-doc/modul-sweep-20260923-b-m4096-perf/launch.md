...
全局batch128、worker16、FSDP8、seed42、1000步；history文件为 `perceptual-framesamp-modul-64frame-8x8.yaml`。验证仅由启动覆盖缩短步数并关闭W&B；正确性取证使用log1/save1与确定性XLA_FLAGS，容量及测速清除XLA_FLAGS。
