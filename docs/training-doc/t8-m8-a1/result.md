...
AWS A100-SXM4-80GB，物理GPU `6,7`，存储为 `/dev/md0` XFS本地NVMe RAID。开始 `2026-09-14T08:02:14Z`，结束 `2026-09-14T09:10:19Z`，墙钟1小时8分5秒；11份状态摘要累计2295.1秒。
...
| 稳态步时均值 | 1.6862秒 |
| 吞吐 | 4.7443 samples/s |
| GPU util均值／0%采样占比 | 96.51%／0.00% |
| 慢步分层 | n=0，均值无样本 |
| 其他步分层 | n=6322，均值96.51% |
