# m2048-b20-base-8x64 结果

本档改前证据完整，现已与同配置CAND完成20+1步逐位对拍，全部201叶、五标量和输入一致；详见[候选结果](../m2048-b20-cand-8x64/result.md)。此结果仅针对旧8×64，不单独证明2048功能。
...
起跑代码为 `29a27c0be9f218ca0cfe4ab2abf1d3372ed308b6`，生产src与初始c31b0509be3f76a6cc262fd655f5f0080b12c266相同；运行期间HEAD与源码保持不变。起点2026-09-21T00:58:51Z，终点2026-09-21T02:02:06Z，驱动记录的墙钟约3795.0秒。GPU4、5，batch8、worker4、FSDP2、seed42。环境B：8×A100-SXM4-80GB，/dev/md0 XFS本地NVMe RAID。训练摘要每次约183–185秒，是验证开销，不用于估计正式训练速度。
