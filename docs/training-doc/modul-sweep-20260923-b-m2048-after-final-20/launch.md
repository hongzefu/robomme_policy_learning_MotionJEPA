...
全局batch128、worker16、FSDP8、seed42、20步；history文件为 `perceptual-framesamp-modul-32frame-8x8.yaml`。验证仅由启动覆盖缩短步数并关闭W&B；正确性取证使用log1/save1与确定性XLA_FLAGS，容量及测速清除XLA_FLAGS。
...
实际UTC为 2026-09-23T03:01:07.445135+00:00 → 2026-09-23T03:56:51.964162+00:00，耗时 3344.519 秒，退出码0。取证器提交 `5e97d52a6420fdfd85620773b0496526bbf589a4`，训练源码提交 `5e97d52a6420fdfd85620773b0496526bbf589a4`；tmux为 `modul-sweep-20260923T011058Z`。
