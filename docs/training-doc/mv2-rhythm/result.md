...
19项测试通过（5.71秒）：真实EpisodeState/pack_buffer控制流覆盖C=15/16/17、31/32/33及1295/1296/1297/1300/1301/1400，并保留两个未截断参考的反例；代表名单与全量预算分派测试继续通过。g317实际memory/policy短测完成67/67/67点，rhythm/termination均PASS，19.22秒、EXIT_CODE=0，见 [terminal-precheck.json](records/terminal-precheck.json)。短测在本轮工作区执行；完整35例将在修补提交后用独立路径重跑。
