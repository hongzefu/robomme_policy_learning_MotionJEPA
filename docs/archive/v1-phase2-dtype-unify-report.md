...
> commit 拓扑、红线自检、审计修正记录）留在源计划文件 [`0826-dtype-unify-plan.md`](../../0826-dtype-unify-plan.md) 第二部分。
...
[`0827-framesamp-restructure-plan.md`](../../0827-framesamp-restructure-plan.md)。
...
- 源计划与实现级细节（代码改动逐行、工具参数、位型容器格式定义、commit 拓扑、红线、审计修正记录）：
  [`0826-dtype-unify-plan.md`](../../0826-dtype-unify-plan.md) 第二部分
