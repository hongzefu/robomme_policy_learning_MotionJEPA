...
| 档案 | 库 | 内容 | 状态 |
|---|---|---|---|
| [`4task-v2-1600ep-604f16da/`](4task-v2-1600ep-604f16da/launch.md) | `v1-store/datasets/4task-v2-1600ep-604f16da` | 私有新版四任务全部 1600 primary；合并 H5、SigLIP、两档 framesamp 和独立 norm_stats | 数据产物及全量验证通过，20 步训练待验收（[result](4task-v2-1600ep-604f16da/result.md)） |
