...
> **⚠ 本文件已被 [`v2-framesamp-restructure-plan.md`](v2-framesamp-restructure-plan.md) 取代（2026-08-27，用户拍板干净重写并与 IO 重构计划合并为独立可执行单一文档）**：基线链的唯一权威载体（符号总表、登记簿 T8、量化判据、preflight 规约）自该日起移交 v2 文件维护；本文件只作历史存档，不再更新，内容与 v2 冲突时一律以 v2 为准。
