...
> **人类审阅版报告**：本文件第一部分与全部实测结论已整理为 [`docs/v1-phase1-gradient-baseline-report.md`](docs/v1-phase1-gradient-baseline-report.md)（第一阶段报告，另含原 `docs/v1-determinism-conclusions.md` 并入的四档确定性结论）。只想看做了什么、结论是什么，读那份；本文件保留实现级细节（第二部分 T1–T10）。
